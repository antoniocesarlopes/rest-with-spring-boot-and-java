package br.com.example.security.jwt;
...
import br.com.example.data.vo.v1.security.TokenVO;
import br.com.example.exception.InvalidJwtAuthenticationException;
...
public class JwtTokenProvider {
	...
	private String getAccessToken(String username, List<String> roles, Date now, Date validity) {
		String issuerUrl = ServletUriComponentsBuilder
				.fromCurrentContextPath().build().toUriString(); //URL de onde este token foi gerado
		return JWT.create()
